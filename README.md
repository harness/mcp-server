...
212 resource types organized across 35 toolsets. Each resource type supports a subset of CRUD operations and optional execute actions.
...
```
                ...
                |  35 Toolsets      |      (data files, not code)
                |  212 Resource Types|
                 +--------+---------+
                          |
                 +--------v---------+
