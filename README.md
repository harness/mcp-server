...
- `create_snow_ticket_for_ccm_rec`: Creates a Service Now ticket for a recommendation in Harness Cloud Cost Management.
...
- `ccm_get_commitment_spends`: Returns Commitment Orchestrator spend details for an account in Harness Cloud Cost Management, broken down by commitment type (Reserved Instances and Savings Plans) with month-over-month trend data.
