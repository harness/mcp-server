...
func (c *Client) ExemptionsFindExemptionById(ctx context.Context, id string, params *ExemptionsFindExemptionByIdParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewExemptionsFindExemptionByIdRequest(c.Server, id, params)
	if err != nil {
		return nil, err
	}
...
func NewExemptionsFindExemptionByIdRequest(server string, id string, params *ExemptionsFindExemptionByIdParams) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/api/v2/exemptions/%s", pathParam0)
	if operationPath[0] == '/' {
	...
	if params != nil {
		...
		if params.IgnoreScope != nil {

			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "ignoreScope", runtime.ParamLocationQuery, *params.IgnoreScope); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
func NewFrontendAllIssuesListRequest(server string, params *FrontendAllIssuesListParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.SeverityOverriden != nil {

			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "severityOverriden", runtime.ParamLocationQuery, *params.SeverityOverriden); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
func (r ExemptionsFindExemptionByIdResponse) Status() string {
...
func (r ExemptionsFindExemptionByIdResponse) StatusCode() int {
	if r.HTTPResponse != nil {
...
func (c *ClientWithResponses) ExemptionsFindExemptionByIdWithResponse(ctx context.Context, id string, params *ExemptionsFindExemptionByIdParams, reqEditors ...RequestEditorFn) (*ExemptionsFindExemptionByIdResponse, error) {
	rsp, err := c.ExemptionsFindExemptionById(ctx, id, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseExemptionsFindExemptionByIdResponse(rsp)
}
...
func ParseExemptionsFindExemptionByIdResponse(rsp *http.Response) (*ExemptionsFindExemptionByIdResponse, error) {
	...
	response := &ExemptionsFindExemptionByIdResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
