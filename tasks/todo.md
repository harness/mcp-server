...
- Expanded `docs-consistency.test.ts` (+4 tests) so key architecture/safety rules in `docs/coding-standards.md` cannot drift silently.
- Verification passed: `pnpm standards:check` (88 tests), `pnpm test` (2470 tests).
