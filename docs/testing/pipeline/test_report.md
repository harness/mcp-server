...
| TC-pipeline-028 | Retry a failed execution | `harness_execute(resource_type="pipeline", action="retry", resource_id="my_pipeline", params={execution_id: "exec_abc123"})` | Failed execution retried from resumable stages | ⬜ Pending | | |
