...
describe("ConfigSchema", () => {
  ...
  it("accepts HARNESS_SEARCH_SERVICE_URL without Zod URL validation (runtime HTTP client validates reachability)", () => {
    const result = ConfigSchema.safeParse({
      ...validConfig,
  ...
  it("rejects MCP_SESSION_TTL_MS below one millisecond", () => {
    const result = ConfigSchema.safeParse({
      ...validConfig,
