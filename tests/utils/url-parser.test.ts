...
describe("applyUrlDefaults", () => {
  ...
  it("still merges URL org/project for Harness-native-only fme_segment_definition even with a stray workspace_id", () => {
    const result = applyUrlDefaults(
      { resource_type: "fme_segment_definition", workspace_id: "stale-ws" } as Record<string, unknown>,
      "https://app.harness.io/ng/account/abc/all/orgs/myOrg/projects/myProject/services",
    );
