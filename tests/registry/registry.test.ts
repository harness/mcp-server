...
describe("Registry", () => {
  ...
  describe("methodBuilder and input-aware responseExtractor", () => {
    ...
    it("cost_recommendation_count get does not include costCategoryDTOs when only cost_category is provided", async () => {
    ...
    it("cost_recommendation_stats get does not include costCategoryDTOs when only cost_category is provided", async () => {
      const mockRequest = vi.fn().mockResolvedValue({ data: {} });
      const client = makeClient(mockRequest);
