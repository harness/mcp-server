/**
 * Single source of truth for allowed MCP tool handlers.
 * Used by architecture and docs-consistency tests to prevent drift.
 */
...
/** GitHub workflows that must run architecture guardrails. */
export const WORKFLOWS_REQUIRING_STANDARDS_CHECK = [
