...
import {
  ALLOWED_MCP_TOOLS as ALLOWED_MCP_TOOL_LIST,
  ALLOWED_REGISTER_TOOL_FILES as ALLOWED_REGISTER_TOOL_FILE_LIST,
...
const ALLOWED_MCP_TOOLS = new Set(ALLOWED_MCP_TOOL_LIST);

/** Only these files may call server.registerTool(). */
const ALLOWED_REGISTER_TOOL_FILES = new Set(ALLOWED_REGISTER_TOOL_FILE_LIST);
