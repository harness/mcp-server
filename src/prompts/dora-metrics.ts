...
Steps:
1. Call harness_get with resource_type="developer_insights_dora_metric", metric="deployment_frequency"${teamFilter}${dateFilter} to get deployment frequency data
2. Call harness_get with resource_type="developer_insights_dora_metric", metric="change_failure_rate"${teamFilter}${dateFilter} to get change failure rate
3. Call harness_get with resource_type="developer_insights_dora_metric", metric="mttr"${teamFilter}${dateFilter} to get mean time to recovery
4. Call harness_get with resource_type="developer_insights_dora_metric", metric="lead_time"${teamFilter}${dateFilter} to get lead time for changes
