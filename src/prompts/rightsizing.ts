...
3. **Full list**: Call harness_list with resource_type="cost_recommendation"${projectFilter}, params={compact: false} to get individual recommendations. For a team/BU, add cost_category + cost_buckets (discover via cost_recommendation_filter).
