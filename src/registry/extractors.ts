...
// ---------------------------------------------------------------------------
// Evidence Vault (attestation) extractors
// ---------------------------------------------------------------------------
...
export function presignedDownloadExtract(raw: unknown): Record<string, unknown> {
  if (!isRecord(raw)) return {};
  const out: Record<string, unknown> = {};
...
/** @deprecated Use presignedDownloadExtract — kept for attestation download endpoint wiring. */
export const attestationDownloadExtract = presignedDownloadExtract;

/** @deprecated Use presignedDownloadExtract — kept for SBOM download endpoint wiring. */
export const sbomDownloadExtract = presignedDownloadExtract;
