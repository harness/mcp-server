...
- resource_type=execution (harness_execute, action=interrupt): Interrupts a running DR test execution. Use execution_id from spec.pipeline.recentRuns (in the DR test response). Set interrupt_type to AbortAll or UserMarkedFailure.
