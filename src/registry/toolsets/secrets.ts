  ...
  resources: [
    {
      resourceType: "secret",
      displayName: "Secret",
      description: "Secret metadata (name, type, scope). Values are NEVER returned. Read-only. Default list/get scope is project — pass org_id and project_id (or a project URL) on the first call. Use resource_scope='account' only when the user asked for account-level secret metadata.",
      toolset: "secrets",
      scope: "project",
