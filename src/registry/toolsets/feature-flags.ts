  ...
  resources: [
    ...
    // which Split.io does not use. Auth is via Bearer token (HARNESS_API_KEY).
    {
      ...
      operations: {
        ...
        get: {
          method: "GET",
          path: "/internal/api/v2/workspaces/{wsId}",
          operationPolicy: { risk: "read", retryPolicy: "safe" },
          pathParams: { workspace_id: "wsId" },
          responseExtractor: passthrough,
          description: "Get a specific workspace by ID. Returns name, owner, traffic types, and environment list.",
        },
      },
    },
    {
      ...
      description: "Feature Management environment. Supports list and get. Requires a workspace_id.",
      toolset: "feature-flags",
      scope: "account",
      ...
      operations: {
        ...
        get: {
          method: "GET",
          path: "/internal/api/v2/environments/ws/{wsId}/{environmentId}",
          operationPolicy: { risk: "read", retryPolicy: "safe" },
          pathParams: { workspace_id: "wsId", environment_id: "environmentId" },
          responseExtractor: passthrough,
          description: "Get a specific environment by ID. Returns name, production flag, and configuration details.",
        },
      },
    },
    {
