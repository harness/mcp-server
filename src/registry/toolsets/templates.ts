  ...
  resources: [
    {
      ...
      description: "Reusable template definition. Supports list, get, create, update, and delete. Pass org_id and/or project_id to control scope — omitting both queries account-level templates.",
      toolset: "templates",
      scope: "project",
      scopeOptional: true,
