  ...
  server.registerTool(
    "harness_list",
    {
      ...
      inputSchema: {
        ...
        size: z.number().min(1).max(100).default(20).optional().describe("Page size (1–100). Some resource types enforce a lower max (e.g. application_security_exemption max 50) — call harness_describe for per-resource limits."),
