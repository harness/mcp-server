...
import (
	...
	"github.com/harness/mcp-server/common/client/dto"     // Corrected import path for Scope
	pkgDTO "github.com/harness/mcp-server/common/pkg/dto" // Alias for the other DTOs
)
