...
const (
	ASC  CodeRepositoriesListParamsOrder = "ASC"
	DESC CodeRepositoriesListParamsOrder = "DESC"
)
...
func (c *Client) GetArtifactComponentRemediationByPurl(ctx context.Context, org OrgParam, project ProjectParam, artifact Artifact, params *GetArtifactComponentRemediationByPurlParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetArtifactComponentRemediationByPurlRequest(c.Server, org, project, artifact, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetArtifactV2DetailComponentViewWithBody(ctx context.Context, org OrgParam, project ProjectParam, artifact Artifact, params *GetArtifactV2DetailComponentViewParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetArtifactV2DetailComponentViewRequestWithBody(c.Server, org, project, artifact, params, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetArtifactV2DetailComponentView(ctx context.Context, org OrgParam, project ProjectParam, artifact Artifact, params *GetArtifactV2DetailComponentViewParams, body GetArtifactV2DetailComponentViewJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetArtifactV2DetailComponentViewRequest(c.Server, org, project, artifact, params, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewGetArtifactComponentRemediationByPurlRequest(server string, org OrgParam, project ProjectParam, artifact Artifact, params *GetArtifactComponentRemediationByPurlParams) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/v1/orgs/%s/projects/%s/artifacts/%s/component/remediation", pathParam0, pathParam1, pathParam2)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
	...
	if params != nil {
		...
		if params.TargetVersion != nil {
			...
			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "target_version", runtime.ParamLocationQuery, *params.TargetVersion); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
func NewGetArtifactV2DetailComponentViewRequest(server string, org OrgParam, project ProjectParam, artifact Artifact, params *GetArtifactV2DetailComponentViewParams, body GetArtifactV2DetailComponentViewJSONRequestBody) (*http.Request, error) {
	...
	bodyReader = bytes.NewReader(buf)
	return NewGetArtifactV2DetailComponentViewRequestWithBody(server, org, project, artifact, params, "application/json", bodyReader)
}
...
func NewGetArtifactV2DetailComponentViewRequestWithBody(server string, org OrgParam, project ProjectParam, artifact Artifact, params *GetArtifactV2DetailComponentViewParams, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/v1/orgs/%s/projects/%s/artifacts/%s/components", pathParam0, pathParam1, pathParam2)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// Status returns HTTPResponse.Status
func (r GetArtifactComponentRemediationByPurlResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetArtifactComponentRemediationByPurlResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// Status returns HTTPResponse.Status
func (r GetArtifactV2DetailComponentViewResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetArtifactV2DetailComponentViewResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
func (c *ClientWithResponses) GetArtifactComponentRemediationByPurlWithResponse(ctx context.Context, org OrgParam, project ProjectParam, artifact Artifact, params *GetArtifactComponentRemediationByPurlParams, reqEditors ...RequestEditorFn) (*GetArtifactComponentRemediationByPurlResponse, error) {
	rsp, err := c.GetArtifactComponentRemediationByPurl(ctx, org, project, artifact, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetArtifactComponentRemediationByPurlResponse(rsp)
}
...
func (c *ClientWithResponses) GetArtifactV2DetailComponentViewWithBodyWithResponse(ctx context.Context, org OrgParam, project ProjectParam, artifact Artifact, params *GetArtifactV2DetailComponentViewParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*GetArtifactV2DetailComponentViewResponse, error) {
	rsp, err := c.GetArtifactV2DetailComponentViewWithBody(ctx, org, project, artifact, params, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetArtifactV2DetailComponentViewResponse(rsp)
}

func (c *ClientWithResponses) GetArtifactV2DetailComponentViewWithResponse(ctx context.Context, org OrgParam, project ProjectParam, artifact Artifact, params *GetArtifactV2DetailComponentViewParams, body GetArtifactV2DetailComponentViewJSONRequestBody, reqEditors ...RequestEditorFn) (*GetArtifactV2DetailComponentViewResponse, error) {
	rsp, err := c.GetArtifactV2DetailComponentView(ctx, org, project, artifact, params, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetArtifactV2DetailComponentViewResponse(rsp)
...
func ParseListArtifactSourcesResponse(rsp *http.Response) (*ListArtifactSourcesResponse, error) {
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest ArtifactSourcesListingHttpResponse
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
...
func ParseGetArtifactComponentRemediationByPurlResponse(rsp *http.Response) (*GetArtifactComponentRemediationByPurlResponse, error) {
	...
	response := &GetArtifactComponentRemediationByPurlResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest ArtifactComponentRemediationResponseBody
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
...
func ParseGetArtifactV2DetailComponentViewResponse(rsp *http.Response) (*GetArtifactV2DetailComponentViewResponse, error) {
	...
	response := &GetArtifactV2DetailComponentViewResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest ArtifactComponentViewResponseBody
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
